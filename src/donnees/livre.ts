...
export const livre: Evt[] = [
    {
        ...
        description: [
        {
            ...
            contenu: `
                  ...
                  Voilà ma proposition. Voilà le sortilège. Mais vous avez deux choses à faire avant que nous ne partions. Deux démarches où intervient l'arithmétique.
                  
                  A votre arrivée, vous n'aurez pas de VIE. Pas de VIE signifie que vous ne pouvez rien faire. Ce qui n'offre guère de perspectives d'aventures. Donc, il vous faut acquérir un minimum de VIE avant de vous mettre en route. Je vais vous expliquer la marche à suivre. D'abord, vous prenez vos dés et vous les lancez. Vous additionnez les deux nombres obtenus. Puis vous multipliez le total par quatre. Vous notez ensuite ce total qui sera le total de départ de POINTS DE VIE. dont vous disposerez pour votre aventure une fois le sortilège lancé. Vous constaterez que vous ne pouvez obtenir moins de 8 ou plus de 48. (Cela je le sais parce que je suis magicien.) Si votre total vous semble défavorable, vous pouvez relancer les dés, histoire d'obtenir un meilleur résultat. En fait, vous pouvez lancer les dés trois fois et choisir le meilleur résultat des trois. Si vous n'avez qu'un dé pour commencer, pas de problème. Au lieu de lancer les deux dés, vous en lancez un deux fois et vous additionnez les chiffres obtenus que vous multipliez ensuite par quatre. Le résultat est le même, en fin de compte. Ah, j'allais oublier... Il faut que vous appreniez à combattre. Sinon vous ne me serez guère utile. Un chevalier incapable de se battre se fait tuer toutes les cinq minutes. On en retrouve des morceaux dispersés un peu partout. Et je ne veux absolument pas que mon apprenti finisse de cette manière. La façon de combattre, dans mon époque, est très particulière. Il faut que vous lanciez les dés. Deux ensemble ou un seul dé deux fois. Peu importe. Si VOUS obtenez plus de 6, c'est que vous avez touché votre ennemi, que vous l'avez sonné d'un bon coup ou quelque chose d'approchant. Qu'en dites-vous ? si vous obtenez 6 ou moins, c'est que vous avez maladroitement frappé à côté. Ça peut arriver. Quand j'étais gosse, je me battais tout le temps et je tapais souvent à côté.
                  
                  Admettons que vous ayez touché votre adversaire. Alors ? Eh bien, pour chaque point marqué au-dessus de 6, vous lui avez causé un dommage correspond Si vous obtenez 7, vous marquez contre lui 1 Point de Dommage. Si vous obtenez 8, vous marquez 2 Points de Dommage et ainsi de suite. Mais ne trichez pas. Tricher rompt le sortilège. Chaque Point de Dommage marqué contre votre ennemi est déduit de ses points de vie. A moins qu'il ne porte une armure, auquel cas le Point de Dommage est marque contre son armure jusqu'à ce que vous la transperciez. A la suite de quoi, tous les autres dommages se déduisent de ses points de vie. Maintenant, faites attention, c'est très important. Quand il ne reste à votre ennemi que 5 points de vie. il tombe évanoui. S'il ne lui en reste pas du tout, vous l'avez tué. Il est mort et bien mort. Tout cela, c'est ce qui arrive si vous attaquez votre ennemi à mains nues. Si vous le pourfendez avec une epée ou si vous pointez sur lui un épieu, ou brandissez un gourdin, vous marquerez des Points de Dommage supplémentaires. Mais pour l'instant, ne vous souciez pas de cela. Vous apprendrez à vous servir d'épées ou d'autres armes quand vous serez arrivé à mon époque. Vous apprendrez également la magie, mais ceci est une autre histoire. Se battre est facile, n'est-ce pas ? Et, à la réflexion, un seul problème sérieux se pose à ce sujet. Alors que vous malmenez votre ennemi lui, de son côté, (ou elle, les femmes sont très dangereuses, par ici) vous malmène également presque toujours. Chacun s'en donne à coeur joie, c'est la règle du jeu. Votre adversaire se battra exactement comme vous en lançant les dés. (A ceci près que c'est vous qui les lancerez pour lui, bien entendu, puisque c'est vous qui les avez en main). S'il obtient plus de 6, il a réussi à vous toucher. Et chaque point au-dessus de 6 lui vaut un dommage contre vous, soustrait de vos POINTS DE VIE (ou de votre armure, puis de vos POINTS DE VIE). Jusqu'à ce qu'il vous reste 5 et vous tombez évanoui, ou rien du tout et vous êtes mort. Bon, voilà donc tout ce qu'il vous faut savoir du combat pour le moment. Mais, avant de lancer mon sortilège, je ferais bien de vous parler du Sommeil. Le sommeil, c'est le moyen pour vous de récupérer des POINTS DE VIE. Vous pouvez dormir lorsque vous le désirerez (excepté au milieu d'un combat, cela va sans dire). Et chaque fois que vous avez réussi à dormir, vous avez le droit de lancer les dés deux fois de suite et d'ajouter le total que vous obtiendrez au total de POINTS DE VIE qui sera le vôtre alors.
                  
                  Il y a tout de même un hic. Pour vous endormir, lancez un dé unique. Si vous marquez 1, 2, 3 ou 4, vous accédez au Temps du Rêve dont vous trouverez les règles à la fin de ce volume (page 179). Et, dans le reve, vous risquez de perdre encore des POINTS DE VIE Peut-être même de vous faire tuer. Mais c'est ainsi que la terre tourne. Si vous avez besoin de points DE VIE, tentez votre chance avec le Rêve en esperant faire un 5 ou un 6.
                  
                  ah,j'allais oublier. Quand vous arriverez dans mon epoque, votre nom deviendra Pip. Je n'y peux rien. Cest le nom du corps que je vous ai choisi. Quand le Roi était jeune, on l'appelait Verrue. Mais surtout. ne lui racontez jamais ce que je vous ai dit. Enfin, il faut que vous soyez renseigné sur l'Expérience. Vous gagnez 1 point d'expérience chaque fois que vous gagnez un combat ou que vous résolvez une énigme. Faites-en le compte avec soin car, chaque fois que vous avez totalisé 20 points d'experience, vous obtenez 1 point permanent de vie qui peut s'ajouter à vos points de vie. Dans ce cas votre total de points de vie peut être supérieur au total de départ. Mieux encore, vous pouvez mettre de côté jusqu'à 10 points permanents de vie qui pourront vous être utiles dans d'autres aventures. En outre, un haut fait véritablement héroïque peut souvent vous valoir plus d'1 point d'expérience.
                  
                  Voilà à peu près tout ce que vous avez besoin de savoir pour tenter l'aventure. Vous pourrez encore, au cours de votre mission, apprendre à utiliser la corruption et à tester les Réactions Amicales d'autrui. Ces règles, comme toutes les autres, figurent en page 188 de ce livre. N'hésitez surtout pas à vous y reporter.
                  
                  Et maintenant, passons au sortilège.
                  
                  Avis concernant le jeu : 
                  
                  1. ' Une fois que vous serez entré dans le Château des Ténèbres, il sera judicieux d'établir une carte, ce qui vous permettra de vous orienter et d'éviter de vous perdre. N'oubliez pas d'y faire figurer les quatre points cardinaux. Tout en parcourant les diverses parties du château, ayez soin de relever sur cette carte les couloirs et les pièces décrites. Inutile d'entrer dans les détails (à moins que vous n'en ayez envie), mais notez les numéros de chaque paragraphe, et les particularités que vous aurez pu découvrir çà et là.
                  
                  2: Cette aventure est la vôtre. Tout en progressant dans le château (et en dessinant votre carte) vous vous familiariserez de plus en plus avec la disposition des lieux. N'ayez pas peur de revenir dans une partie du château que vous avez visitée, si votre carte vous indique que c'est une solution possible : car vous êtes libre d'aller et venir à votre guise tant que vous savez où vous vous dirigez, avec l'assurance que la voie n'est pas barrée.
                  
                  3. Au fur et à mesure du déroulement de l'aventure, vous allez courir de plus en plus de risques. Autrement dit, vous feriez bien de ne pas vous séparer de vos armes les plus puissantes (les Boules de Feu en particulier) jusqu'à ce que vous vous trouviez face à face avec le sorcier Ansalom. Ce n'est pas une obligation, naturellement, mais un bon conseil.
                  
                  4: Pour la même raison, vous avez intérêt à ne pas gaspiller vos Potions Curatives. Mais les Potions peuvent vous jouer des tours. Si vous en abusez, par exemple, vous risquez de vous trouver démuni à un moment où vous en auriez un besoin vital. En générai prenez une Potion Curative quand vous constatez une diminution alarmante de vos points de vie, non quand vous en avez seulement perdu un ou deux, Souvenez-vous que vous pouvez toujours en regagner par le Sommeil. Ceci présente un risque, certes. car il y a toujours le danger d'une rencontre avec un Monstre du Sommeil susceptible d'entraîner de désastreux résultats. Mais, quand vous pourrez dormir en paix, vous récupérerez des points de vie sans utiliser vos Potions Curatives.
                  
                  5 :Voici une remarque importante. Il pourrait vous àrriver de croire que vous avez totalement exploré le chateau des Ténèbres, sans avoir découvert le moindre signe de la présence de la Reine ou même du sorcier Ansalom. Ceci s'explique parce qu'Ansalom est un sorcier très astucieux et que son château est plein de détours et de recoins. Il est tout à fait possible que vous n'ayez pas remarqué une porte ou un couloir secret. Donc, n'hésitez pas, en utilisant votre carte, a revenir en des lieux déjà connus, et reprenez-en l'examen attentif et méthodique. Ceci est capital. Dîtes-vous qu'il est très difficile de trouver la Reine et le sorcier Ansalom à la première tentative.
